...
@WebServlet(urlPatterns = { "/createStud" })
public class CreateStudServlet extends HttpServlet {
  @EJB
  ...
  @EJB
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("grList", lst);
         RequestDispatcher dispatcher = request.getServletContext()
                .getRequestDispatcher("/WEB-INF/views/createStudView.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        db.create(Long.valueOf(NomerZachetki), Integer.valueOf(ShifrGruppyi), Familiya, Imya, Otchestvo, Gorod, Adres, Tel, Status,new Date());
